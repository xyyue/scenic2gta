...
class Targets:
    ...
    def parse(self, frame, jsonstr, i, index):
        try:
        ...
        with gzip.open(fname, mode='wb', compresslevel=9) as gz_file:
...
class Client:
    ...
    def recvMessage(self, i, index):
        ...
        if not data: 
            ...
            return None
        return self.targets.parse(frame, data.decode('utf-8'), i, index)
